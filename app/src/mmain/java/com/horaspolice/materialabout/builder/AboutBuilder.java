package com.horaspolice.materialabout.builder;
...
import com.horaspolice.materialabout.util.ColorUtil;
import com.horaspolice.materialabout.util.IconUtil;
import com.horaspolice.materialabout.util.IntentUtil;
import com.horaspolice.materialabout.views.AboutView;
import com.horaspolice.R;

import java.util.LinkedList;

import static com.horaspolice.R.mipmap.share;
...
public final class AboutBuilder {
    ...
    public AboutBuilder setVersionNameAsAppSubTitle() {
        try {
            return setAppTitle(context.getString(com.horaspolice.R.string.version, getPackageInfo().versionName));
